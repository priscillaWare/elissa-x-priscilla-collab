...
int start2(void *arg)
{
    ...
    kidpid = spork("XXp0", XXp1, (void*)(long)0, 2 * USLOSS_MIN_STACK, 2);
    kidpid = spork("XXp1", XXp1, (void*)(long)1, 2 * USLOSS_MIN_STACK, 2);
    kidpid = spork("XXp2", XXp1, (void*)(long)2, 2 * USLOSS_MIN_STACK, 2);
    kidpid = spork("XXp3", XXp1, (void*)(long)3, 2 * USLOSS_MIN_STACK, 2);
